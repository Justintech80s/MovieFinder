...
function offerMatches(offer,intent){
  ...
  if(intent.maxPrice!=null){
    ...
    if(offer?.currency&&String(offer.currency).toUpperCase()!=='USD') return false;
  }
  return true;
}
...
export function matchesHardConstraints(movie={},intent={}){
  ...
  if(intent.provider||intent.freeOnly||intent.rentOnly||intent.buyOnly||intent.maxPrice!=null){
