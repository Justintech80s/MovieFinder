...
export function parseIntent(query='') {
  ...
  if (person) return { raw, ...person, titleQuery:null, provider, freeOnly, rentOnly, buyOnly, filmographyView, genreWords, rtMin };
  return { raw, kind:'catalog', personName:null, role:null, titleQuery:null, provider, freeOnly, rentOnly, buyOnly, filmographyView:null, genreWords, rtMin, confidence:0.7 };
}
