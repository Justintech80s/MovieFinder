...
export function parseIntent(query='') {
  ...
  if (person) return { raw, ...person, titleQuery:null, provider, freeOnly, rentOnly, buyOnly, filmographyView, genreWords };
  return { raw, kind:'catalog', personName:null, role:null, titleQuery:null, provider, freeOnly, rentOnly, buyOnly, filmographyView:null, genreWords, confidence:0.7 };
}
